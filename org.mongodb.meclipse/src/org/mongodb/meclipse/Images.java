...
public enum Images {
	...
	// ServerConnected("server.png"),
	// ServerDisconnected("server_disconnected.png"),
	Error("error.gif"), Modified("modified.png"), NewServer("newServer.png"), PageCommit(
			"new_connection.png"), Macro("macro.gif"), Word("word.png"), Template(
			"template.gif"), CreatePage("create_page.png"), GetNext("next.gif"), GetAll(
			"getAll.gif"), Find("find.gif"), Step("step.gif"), Help("help.gif"), Trac16(
			"trac_16.png"), Trac48("trac_48.png");
